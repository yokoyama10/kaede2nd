...
【配布場所】 http://en.hocha.org/up/ 以下のどこか
====================================================================
...
本ソフトは、SQLite（ファイルを直接開くデータベース）と、MySQL（サーバーに接続するデータベース）の両方に対応しています。
...
58期縁日班長 横山 秀（よこやま しゅう）

shuyoko@gmail.com
03-3704-1061 / 090-1766-3243

〒158-0086
東京都世田谷区尾山台1-14-20

Twitter: @yuaaa or @shuyoko

商品回収実施の連絡くださいな。同期に廻します。
本ソフトに関する質問・改善要求などは、生命の続く限り対処するつもりです。お気軽にどうぞ。


Subversionリポジトリ
http://svn.hocha.org/svnroot/ennichi/trunk/kaede2nd/
Visual Studio 2008 (C#) を使用して書かれています。

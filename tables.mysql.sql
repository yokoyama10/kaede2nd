...
CREATE TABLE operator (
	operator_id INTEGER UNSIGNED AUTO_INCREMENT NOT NULL, #受付者ID
...
CREATE TABLE receipt (
	receipt_id INTEGER UNSIGNED AUTO_INCREMENT NOT NULL, #受付書ID
	...
	receipt_operator INTEGER UNSIGNED default NULL, #受付者
...
CREATE TABLE item (
	item_id INTEGER UNSIGNED AUTO_INCREMENT NOT NULL, #商品ID
	item_receipt_id INTEGER UNSIGNED NOT NULL, #受付書ID
	item_name VARCHAR(255) NOT NULL, #商品名
	item_tagprice INTEGER UNSIGNED NOT NULL default 0, #定価
	...
	item_receipt_operator INTEGER UNSIGNED default NULL, #受付者（代替）

	item_sellprice INTEGER UNSIGNED default NULL, #売価
	item_selltime DATETIME default NULL, #販売時刻
	item_sell_operator INTEGER UNSIGNED default NULL, #販売入力者

	item_kansa_end DATETIME default NULL, #監査終了時刻
	item_kansa_flag1 INTEGER UNSIGNED default NULL, #監査フラグ
	
	item_adjust INTEGER SIGNED default NULL, #事故時調整額（未使用）

	item_isbn BIGINT(20) UNSIGNED default NULL, #ISBNコード
	item_volumes INTEGER UNSIGNED default NULL, #分冊数
